...
const App: React.FC = () => {
  ...
  async function downloadDailyExcelWithTemplate(
    ...
    try {
      ...
      // ★ 요청사항 1: I51 '판매수량' = 당월 총 판매 수량
      const totalProductMonthlyCount = Object.values(
        productMonthlyCount
      ).reduce((sum, v) => sum + v, 0);
      if (totalProductMonthlyCount !== 0) {
        worksheet.getCell("I51").value = totalProductMonthlyCount;
      }
