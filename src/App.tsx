...
<div className="summary-section" style={{ marginTop: 16 }}>
  <div className="summary-header">
    ...
    <button
      ...
      onClick={() =>
        handleDownloadDailyExcel(sales, expenses, staffList, exportDate)
      }
      disabled={!isAdminMode}
    >
      일일 통계 엑셀 다운로드
...
(
    ...
    // 날짜 셀: 템플릿에서 실제 날짜가 들어가던 위치
    const displayDate = dayjs(dateStr).format("YYYY.MM.DD(ddd)");
    worksheet.getCell("R30").value = displayDate;
